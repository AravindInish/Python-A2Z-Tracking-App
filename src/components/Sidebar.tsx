...
export const Sidebar: React.FC<SidebarProps> = ({
      ...
      <div className="w-full h-full flex flex-col bg-white overflow-hidden select-none">
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-slate-100 flex-shrink-0">
          ...
          <button
            ...
            className="p-2 text-slate-500 hover:text-slate-800 hover:bg-slate-100 active:bg-slate-200 rounded-lg transition-colors flex items-center justify-center -mr-1"
        ...
        {/* Mobile Navigation Links with comfortable touch targets */}
        ...
        {/* Mobile Drawer Bottom Summary */}
        <div className="p-4 border-t border-slate-100 bg-slate-50/70 space-y-3 flex-shrink-0">
          ...
          <button
            ...
            className="w-full text-xs py-2 px-3 bg-white hover:bg-slate-100 active:bg-slate-200 text-slate-800 font-medium border border-slate-200 rounded-lg flex items-center justify-center gap-2 transition-colors shadow-2xs"
          >
  ...
  return (
    <aside
      className={`hidden md:flex fixed inset-y-0 left-0 z-30 flex-col bg-white border-r border-slate-200 transition-all duration-300 ${
        collapsed ? 'w-18' : 'w-64'
      }`}
    >
      {/* Brand Header */}
      <div className="flex items-center justify-between h-16 px-4 border-b border-slate-100 flex-shrink-0">
        ...
        <button
          ...
          className="flex items-center justify-center w-7 h-7 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-md transition-colors"
      ...
      {!collapsed ? (
        <div className="p-3 mx-3 mb-3 bg-slate-50 border border-slate-200 rounded-xl space-y-2.5 flex-shrink-0">
          <div className="flex items-center justify-between text-xs">
        ...
        <div className="p-2 flex flex-col items-center gap-2 mb-3 flex-shrink-0">
          <div
